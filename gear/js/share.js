...
var SH_WSETS         = ['fighting-spirit','salvation','spiked','helper','acrimony','presumption','vision','jorgoth-t4-v1','jorgoth-t4-v2','jorgoth-t4-v3','jorgoth-t3-v1','jorgoth-t3-v2','jorgoth-t3-v3','none','ciclonica'];
...
function encodeProfile(w, id) {
    ...
    var cl = p.collLevels || { normal: 10, large: 10, powerful: 10 };
