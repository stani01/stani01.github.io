...
var MANASTONES = [
    ...
    { key: 'pdef',        name: 'Physical Defence',  stat: 'physicalDef', value: 24 },
    { key: 'mdef',        name: 'Magical Defence',   stat: 'magicalDef',  value: 24 },
...
var CLASS_DATA = {
    ...
    assassin:     { name: 'Assassin',     icon: '../assets/icons/assassin.png',     weapons: ['dagger', 'sword'],                          armorTypes: ['physical-leather'] },
    ...
    cleric:       { name: 'Cleric',       icon: '../assets/icons/cleric.png',       weapons: ['mace'],                                     armorTypes: ['magical-chain'] },
    chanter:      { name: 'Chanter',      icon: '../assets/icons/chanter.png',      weapons: ['staff', 'mace'],                            armorTypes: ['physical-chain'] },
...
var CLASS_ORDER = ['gladiator', 'templar', 'assassin', 'ranger', 'sorcerer', 'spiritmaster',
                   'cleric', 'chanter', 'gunner', 'aethertech', 'bard', 'painter'];
