        ...
        chanter: [
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Deals 807 physical damage.
May stun the target for 2s.`),
                    usageCost: '168 MP',
                    cooldown: '12s',
                    target: 'Selected Target',
                    usageDistance: '1m',
                ...
                rows: {
                    improved: {
                        type1: {
                            ...
                            description: d(`Increases attack speed by 30% for 10s.
Increases movement speed by 30%.
Reduces the casting time by 30%.`),
                            usageCost: '168 MP',
                            cooldown: '10s',
                            target: 'Area within a Radius of Target 6 People',
                            usageDistance: '1m',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 2130 physical damage.
May stun the target for 3s.
If the attack lands a Crit Strike, there is a 100% chance the target will be stunned.`),
                            usageCost: '168 MP',
                            cooldown: '12s',
                            target: 'Selected Target',
                            usageDistance: '1m',
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Increases attack speed by 20% for 10s.
...
Reduces the casting time by 20%.`),
                        ...
                        type2: {
                            ...
                            description: d(`Deals 1775 (+16) physical damage.
May stun the target for 2s.
If the attack lands a Crit Strike, there is a 100% chance the target will be stunned.`),
                            usageCost: '168 MP',
                            cooldown: '12s',
            ...
            },
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Deals 982 physical damage.`),
                    usageCost: '255 MP',
                    cooldown: '16s',
                    target: 'Selected Target',
                    usageDistance: '1m',
                ...
                rows: {
                    improved: {
                        type1: {
                            ...
                            description: d(`Deals 2614 physical damage.
Deals extra damage if the target stumbles.`),
                            usageCost: '3000 HP',
                            cooldown: '16s',
                            target: 'Selected Target',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 1295 physical damage.
Causes the target to stumble.`),
                            usageCost: '255 MP',
                            cooldown: '16s',
                            target: 'Selected Target',
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Deals 2179 (+20) physical damage.`),
                            usageCost: '3000 HP',
                            cooldown: '16s',
                            target: 'Selected Target',
                            usageDistance: '1m',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 1080 (+10) physical damage.
Causes the target to stumble.`),
                            usageCost: '255 MP',
                            cooldown: '24s',
                            target: 'Selected Target',
            ...
            },
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Restores 1601 HP.
Restores an additional 1601 HP every 2s for 10s.`),
                    usageCost: '632 MP',
                    cooldown: '10s',
                    target: 'Selected Target',
                    usageDistance: '1m',
                ...
                rows: {
                    improved: {
                        type1: {
                            ...
                            description: d(`Restores 11527 HP.
Removes a magical debuff from the target every 3 seconds for 10 seconds.`),
                            usageCost: '632 MP',
                            cooldown: '14s',
                            target: 'Selected Target',
                            usageDistance: '1m',
                        ...
                        type2: {
                            ...
                            description: d(`Restores 4610 HP.
                                Restores an additional 4610 HP every 2s for 12s.`),
                            usageCost: '632 MP',
                            cooldown: '12s',
                            castTime: '1s',
                            target: 'Area within a Radius of Target 6 People',
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Restores 9606 (+96) HP.
Removes a magical debuff from the target every 3 seconds for 7 seconds.`),
                            usageCost: '632 MP',
                            cooldown: '14s',
                            target: 'Selected Target',
                            usageDistance: '1m',
                        ...
                        type2: {
                            ...
                            description: d(`Restores 3842 (+38) HP.
Restores an additional 3842 HP every 2s for 10s.`),
                            usageCost: '632 MP',
                            cooldown: '12s',
                            target: 'Area within a Radius of Target 6 People',
                            usageDistance: '1m',
            ...
            },
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Deals 1089 physical damage.
Perfect Resonance Haze.`),
                    usageCost: '311 MP',
                    cooldown: '16s',
                    target: 'Selected Target',
                    usageDistance: '1m',
                ...
                rows: {
                    improved: {
                        ...
                        type2: {
                            ...
                            description: d(`Deals 1568 physical damage.
Increases the effect of the next attack skill by 80% if the target stumbles.
Landing a critical strike increases the probability that the next attack skill will land a critical strike.`),
                            usageCost: '311 MP',
                            cooldown: '16s',
                            target: 'Selected Target',
                            usageDistance: '1m',
                        ...
                        type3: {
                            ...
                            description: d(`Deals 1097 physical damage.
Deals extra damage if the target stumbles.`),
                            usageCost: '311 MP',
                            cooldown: '8s',
                            target: 'Selected Target',
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Deals 1089 physical damage.
Increases the effect of the next attack skill by 20% if the target stumbled.
Landing a critical strike increases the probability that the next attack skill will land a critical strike.`),
                            usageCost: '311 MP',
                            cooldown: '16s',
                            target: 'Selected Target',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 1089 (+10) physical damage.
Increases the effect of the next attack skill by 40% if the target stumbled.
Landing a critical strike increases the probability that the next attack skill will land a critical strike.`),
                            usageCost: '311 MP',
                            cooldown: '16s',
                            target: 'Selected Target',
                        ...
                        type3: {
                            ...
                            description: d(`Deals 762 (+7) physical damage.`),
                            usageCost: '311 MP',
                            cooldown: '8s',
                            target: 'Selected Target',
                            usageDistance: '1m',
            ...
            },
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Deals 803 physical damage.
Multicast 2 times
Perfect Repeated Smite.`),
                    usageCost: '232 MP',
                    cooldown: '8s',
                    target: 'Selected Target',
                    usageDistance: '1m',
                ...
                rows: {
                    improved: {
                        type1: {
                            ...
                            description: d(`Deals 1156 physical damage.
Significantly reduces the target's movement speed.
Also stuns it if the attack lands a Crit Strike.
Multicast 2 times`),
                            usageCost: '232 MP',
                            cooldown: '8s',
                            target: 'Selected Target',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 1927 physical damage.
The target has a high probability of stumbling.`),
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Deals 803 (+7) physical damage.
Reduces the target's movement speed.
Also stuns it if the attack lands a Crit Strike.
Multicast 2 times`),
                            usageCost: '232 MP',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 1606 (+15) physical damage.
May make the target stumble.`),
                            usageCost: '232 MP',
                            cooldown: '8s',
                            target: 'Area within a Radius of Target 8 People',
                            usageDistance: '1m',
            ...
            },
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Reduces your damage by 50% for 12s.
                ...
                rows: {
                    improved: {
                        type1: {
                            ...
                            description: d(`Reduces your damage by 50% for 12s.
Increases Healing Boost by 800.
Restores 6000 HP every 2s.
Also reduces the casting time of healing skills by 20% for 12s.`),
                            usageCost: '3000 DP',
                            cooldown: '2m',
                            target: 'Self',
                            usageDistance: '1m',
...
Increases Resist Fear by 1000.`),
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Reduces your damage by 50% for 12s.
Increases Healing Boost by 500 (+5).
Restores 3000 HP every 2s.
Also reduces the casting time of healing skills by 10% for 12s.`),
                            usageCost: '3000 DP',
                            cooldown: '2m',
                            target: 'Self',
                            usageDistance: '1m',
                        ...
                        type2: {
                            ...
                            description: d(`Reduces your damage by 50% for 10s.
Increases Healing Boost by 500.
Increases Resist Fear by 500 (+10).`),
                            usageCost: '3000 DP',
                            cooldown: '2m',
                            target: 'Selected Target',
                            usageDistance: '1m',
        ...
        aethertech: [
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`After a successful parry or resist magic.
Deals 1148 magical fire damage.
Stuns the target for 2s.`),
                    usageCost: '185 MP',
                    cooldown: '24s',
                    target: 'Selected Target',
                ...
                rows: {
                    improved: {
                        type1: null,
                        type2: {
                            name: '(Improved) Boosted Counter Cannon Fire',
                            icon: '../assets/icons/ri_breakingattack_custom_b_up.png',
                            description: d(`Deals 1378 magic fire damage after a successful dodge weapons and resist magic.
Stuns the target for 2s.
After a hit, the cooldown of Sprint Strike is reset.`),
                            usageCost: '185 MP',
                            cooldown: '24s',
                            target: 'Selected Target',
                            usageDistance: '1m',
                        ...
                        type3: {
                            name: '(Improved) Large-scale Cannon Shot',
                            icon: '../assets/icons/ri_breakingattack_custom_c_up.png',
                            description: d(`Deals 1378 magical fire damage.
Multicast 3 times`),
                            usageCost: '185 MP',
                            cooldown: '24s',
                            target: 'Area within a Radius of Target 6 People',
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Deals 1148 magic fire damage after a successful parry and resist magic.
Stuns the target for 2s.
When using the skill, the cooldown for Sprint Strike is reduced by 50%.
A crit strike resets the cooldown.`),
                            usageCost: '185 MP',
                            cooldown: '24s',
                            target: 'Selected Target',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 1148 (+11) magic fire damage after a successful dodge weapons and resist magic.
Stuns the target for 2s.
When using the skill, the cooldown for Sprint Strike is reduced by 60%.
A crit strike resets the cooldown.`),
                            usageCost: '185 MP',
                            cooldown: '24s',
                            target: 'Selected Target',
                        ...
                        type3: {
                            ...
                            description: d(`Deals 1148 (+11) magical fire damage.
Multicast 2 times`),
                            usageCost: '185 MP',
                            cooldown: '24s',
                            target: 'Area within a Radius of Target 6 People',
            ...
            },
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Increases resistance to movement-restricting states by 300 for 8s.
Increases resistance to shock states by 300.
Increases resist magic by 750.
Increases Add. PvP Def. by 2000.`),
                    usageCost: '309 MP',
                    cooldown: '2m',
                    target: 'Self',
                    usageDistance: '1m',
                ...
                rows: {
                    improved: {
                        type1: {
                            ...
                            description: d(`Increases resistance to movement-restricting states by 1000 for 8s.
Increases resist magic by 750.
Increases Add. PvP Def. by 2000.
Using the skill resets the cooldown for Remove Shock.`),
                            usageCost: '309 MP',
                            cooldown: '1m30s',
                            target: 'Self',
                            usageDistance: '1m',
                        ...
                        type2: {
                            ...
                            description: d(`Increases resistance to movement-restricting states by 1000 for 10s.
Increases resistance to shock states by 1000.
Increases resist magic by 750.
Increases Add. PvP Def. by 2000.`),
                            usageCost: '309 MP',
                            cooldown: '1m30s',
...
Using the skill resets the cooldown for Remove Shock.`),
                        ...
                        type2: {
                            ...
                            description: d(`Increases resistance to movement-restricting states by 300 for 10s.
Increases resistance to shock states by 1000.
Increases resist magic by 750.
Increases Add. PvP Def. by 2000.`),
                            usageCost: '309 MP',
            ...
            },
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Deals 1142 magical fire damage.
Multicast 2 times.`),
                    usageCost: '356 MP',
                    cooldown: '14s',
                    target: 'Selected Target',
                ...
                rows: {
                    improved: {
                        type1: {
                            ...
                            description: d(`Deals 1371 magical fire damage.
Deals more damage when the target is stunned.
Multicast 4 times`),
                            usageCost: '356 MP',
                            cooldown: '14s',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 1371 magical fire damage.
Places a time bomb on the target which detonates after 2 seconds.
Makes the target stumble for 4 seconds.`),
                            usageCost: '356 MP',
                            cooldown: '14s',
                            target: 'Selected Target',
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Deals 1142 (+11) magical fire damage.
Multicast 4 times`),
                            usageCost: '356 MP',
                            cooldown: '14s',
                            target: 'Area within a Radius of Target 6 People',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 1142 (+11) magical fire damage.
Places a time bomb on the target which detonates after 4 seconds.
Makes the target stumble for 3 seconds.`),
                            usageCost: '356 MP',
                            cooldown: '14s',
                            target: 'Selected Target',
                            usageDistance: '1m',
            ...
            },
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Deals 573 magical wind damage.
Silences the target for 5s.`),
                    usageCost: '383 MP',
                    cooldown: '18s',
                    target: 'Selected Target',
                ...
                rows: {
                    improved: {
                        type1: {
                            ...
                            description: d(`Deals 687 magical wind damage.
Silences the target for 5s.
The effect cannot be removed.`),
                            usageCost: '383 MP',
                            cooldown: '40s',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 893 magical wind damage.
Silences the target for 5s.`),
                            usageCost: '383 MP',
                            cooldown: '30s',
                            target: 'Selected Target',
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Deals 573 (+5) magical wind damage.
Silences the target for 4s.
Cannot remove the effect.`),
                            usageCost: '383 MP',
                            cooldown: '40s',
                        ...
                        type2: {
                            ...
                            description: d(`Deals 744 (+7) magical wind damage.
Silences the target for 4s.`),
                            usageCost: '383 MP',
                            cooldown: '30s',
                            target: 'Selected Target',
            ...
            },
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Level 1 - 1.1s
Deals 1299 magical earth damage.
Perfect Idium Fist
─────────────────────────────────────
Level 2 - 1.7s
Deals 2176 magical earth damage.
Increases movement speed by 10% for 5s.
─────────────────────────────────────
Level 3 - 5s
Deals 4110 magical earth damage.
Increases movement speed by 20% for 5s.
Increases attack speed by 15%.
Causes the target to stumble.`),
                    usageCost: '0 MP',
                    cooldown: '10s',
                    castTime: '1.1s (charge skill)',
                    target: 'Selected Target',
                    usageDistance: '1m',
                    area: 'Single Target',
                    areaIcon: 'targetSingle'
                ...
                rows: {
                    improved: {
                        type1: {
                            ...
                            description: d(`Level 1 - 1.1s
Deals 2028 magical earth damage.
─────────────────────────────────────
Level 2 - 1.7s
Deals 3396 magical earth damage.
Increases movement speed by 15% for 5s.
Increases attack speed by 15%.
─────────────────────────────────────
Level 3 - 5s
Deals 6413 magical earth damage.
Increases movement speed by 30% for 5s.
...
Increases attack speed by 25%.
Causes the target to stumble.
Reduces the cooldown for Idium Ray, Idium Whip and Idium Bombardment by 50%.`),
                            usageCost: '0 MP',
                            cooldown: '12s',
                            castTime: '1.1s (charge skill)',
                            target: 'Area within a Radius of Target 8 People',
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Level 1 - 1.1s
Deals 1690 (+17) magical earth damage.
─────────────────────────────────────
Level 2 - 1.7s
Deals 2830 (+28) magical earth damage.
Increases movement speed by 10% for 5s.
Increases attack speed by 10%.
─────────────────────────────────────
Level 3 - 5s
Deals 5344 (+53) magical earth damage.
Increases movement speed by 20% for 5s.
Increases attack speed by 15%.
Causes the target to stumble.`),
                            usageCost: '0 MP',
...
Reduces the cooldown for Idium Ray, Idium Whip and Idium Bombardment by 50%.`),
            ...
            },
            {
                ...
                defaultSkill: {
                    ...
                    description: d(`Increases movement and flight speed by 20%.
Increases Atk. Speed by 20%.
Increases Magic Attack by 750.
Increases Magical Acc by 940.
500 DP are used every 3 sec.
Active Skill.`),
                    usageCost: '500 DP (every 3s)',
                    cooldown: '10s',
                ...
                rows: {
                    improved: {
                        type1: {
                            ...
                            description: d(`Increases movement and flight speed by 25%.
Increases Atk. Speed by 25%.
Increases Magic Attack by 900.
Increases Magical Acc by 1200.
500 DP are used every 3 sec.
Active Skill`),
                            usageCost: '500 DP (every 3s)',
                            cooldown: '8s',
...
You are immobilised and cannot cause immobilisation.
Increases Atk. Speed by 25%.
Increases Magic Attack by 5000.
Increases Magical Acc by 3000.
Increases Resistance to Pull by 1000.
Each time you attack, you have a 10% chance of stunning the target.
...
Active Skill`),
                    ...
                    normal: {
                        type1: {
                            ...
                            description: d(`Increases movement and flight speed by 20%.
Increases Atk. Speed by 20%.
Increases Magic Attack by 800 (+5).
Increases Magical Acc by 1000.
500 DP are used every 3 sec.
Active Skill`),
                            usageCost: '500 DP (every 3s)',
                            cooldown: '10ss',
...
You are immobilised and cannot cause immobilisation.
Increases Atk. Speed by 20%.
Increases Magic Attack by 4000 (+50).
Increases Magical Acc by 2000.
Increases Resistance to Pull by 1000.
Each time you attack, you have a 10% chance of stunning the target.
1,000 DP are used every 3 sec.
Active Skill`),
